...
To optimize the spdnauaa application for production, run:
...
[Using UAA for Microservice Security]: https://www.jhipster.tech/documentation-archive/v5.5.0/using-uaa/[Using JHipster in development]: https://www.jhipster.tech/documentation-archive/v5.5.0/development/
